 ...
 * -----------------------------------------------------------------------
 * $Revision: 1102 $:
 * $Date: 2013-05-10 15:09:35 +0300 (Пт, 10 май 2013) $:
 */
...
if (!defined('VBSSO_SHARED')) {
    ...
    define ('VBSSO_SHARED', VBSSO_PRODUCT_VERSION_1_4_10);
...
//            VBSSO_PLATFORM_FOOTER_LINK_SHOW_ADMIN => 'I want to evaluate it first (don\'t show the link for the public)',
    ...
    define ('VBSSO_NAMED_EVENT_FIELD_SHOW_VBULLETIN_AUTHOR_PROFILE_TITLE', 'Show vBulletin Author Profile');

    define ('VBSSO_NAMED_EVENT_FIELD_SHOW_VBULLETIN_PROFILE', SHAREDAPI_NAME_DEFINITION(VBSSO_PRODUCT_ID, 'vb_profile_url'));
    define ('VBSSO_NAMED_EVENT_FIELD_SHOW_VBULLETIN_PROFILE_TITLE', 'Show vBulletin Profile');
